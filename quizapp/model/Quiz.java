...
public class Quiz implements Gradable {
    ...
    public void showResults() {
        ...
        // Check for grade-related settings errors - if present, skip grade display
        if (com.quizapp.data.DataManager.getInstance().hasGradeSettingsErrors()) {
            System.out.println("  Grade: (Grade scale configuration error)");
        } else {
