...
public class StudentHandler {
    ...
    private void takeQuiz(Student student, boolean enableTimer, int timerSeconds,
        ...
        // Check for grade-related settings errors - warn but allow quiz
        if (dataManager.hasGradeSettingsErrors()) {
            System.out.println("\n*** Warning: Grade scale has configuration errors. ***");
            System.out.println("*** Letter grade and pass/fail status will not be shown. ***\n");
        }
